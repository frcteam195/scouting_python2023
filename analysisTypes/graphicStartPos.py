...
def graphicStartPos(analysis, rsRobotMatchData, rsRobotL2MatchData, rsRobotPitData):
    ...
    if numberOfMatchesPlayed > 0:
        ...
        engaged = (round(rampStatusList.count(5)/numberOfMatchesPlayed, 2)) * 100
        docked = (round(rampStatusList.count(4)/numberOfMatchesPlayed, 2)) * 100
        parked = (round(rampStatusList.count(3)/numberOfMatchesPlayed, 2)) * 100
